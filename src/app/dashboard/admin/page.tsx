...
export default async function AdminDashboard() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-aeonik text-2xl sm:text-3xl font-bold text-blanc">Administration</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {stats.map((stat, i) => (
          ...
          >
            ...
            <p className="font-aeonik text-xl text-blanc mt-1">{stat.value}</p>
          </Link>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Link href="/dashboard/admin/utilisateurs" className="card-noir hover:shadow-gold transition-all">
          ...
          <h3 className="font-aeonik text-xl text-blanc mb-1">Gestion des utilisateurs</h3>
        ...
        <Link href="/dashboard/admin/taux" className="card-noir hover:shadow-gold transition-all">
          ...
          <h3 className="font-aeonik text-xl text-blanc mb-1">Taux de répartition</h3>
