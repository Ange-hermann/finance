...
export default function ScanPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-aeonik text-2xl sm:text-3xl font-bold text-blanc">Scan QR Code</h1>
      ...
      <div className="card-noir">
        <div className="text-center py-8">
          ...
          <h3 className="font-aeonik text-xl text-blanc mb-2">Scanner un QR code</h3>
      ...
      {result && (
        <div className="card-noir animate-fade-in">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="font-aeonik text-xl text-blanc">QR Code décodé</h3>
          </div>
